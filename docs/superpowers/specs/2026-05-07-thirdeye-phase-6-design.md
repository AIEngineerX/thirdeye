...
The earlier roadmap treated Phase 6 as a Next.js frontend wrapping the Phase 1–5 modules and listed AI Assistant as a v2 deferral. After hands-on review of competitor surface (ocula.fun in particular), and with the explicit reframe of ThirdEye as a personal tool rather than a marketed launch, three things change:
